...
if (true) {
	...
	NewWindow($axure.globalVariableProvider.getLinkUrl('Форма_для_заполнения.html'), "", "directories=0, height=650, location=1, menubar=0, resizable=1, scrollbars=1, status=0, toolbar=0, width=500", true, 500, 650);
