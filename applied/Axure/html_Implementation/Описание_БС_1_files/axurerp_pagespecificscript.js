...
if (true) {
	...
	NewWindow($axure.globalVariableProvider.getLinkUrl('Описание_СВП_1.html'), "", "directories=0, height=500, location=1, menubar=0, resizable=1, scrollbars=1, status=0, toolbar=0, width=500, left=100, top=100", false, 500, 500);
